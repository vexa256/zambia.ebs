<template>
  <div>
    ...
    <div class="card-body px-5 py-5 bg-light shadow-lg table-responsive">
      <form method="POST" id="VerifyCebsSignal">
        ...
        <div class="wiz-element col-md-12 my-3 py-3">
          <label id="label" for="" class="required form-label my-1 py-1"
            >Select Signal Source</label
          >
          <select
            id=""
            class="form-select EE-BS-FS form-control form-select-light"
            data-placeholder="Select an option"
            name="WhatIsTheSignalSource"
          >
            <option value="">Select an option</option>
            <option value="Community">Community</option>
            <option value="Hotline">Hotline</option>
            <option value="Median Scanning">Median Scanning</option>
            <option value="Vet Facility">Vet Facility</option>
        ...
        <input
          type="text"
          name="PostRoute"
          value="VerifyTheCebsSignal"
          class="d-none"
        />
        <input
          type="text"
          name="TableName"
          value="signal_verifications"
          class="d-none"
        />
        <input type="hidden" name="ReportID" class="ReportID" />
        <input
          type="hidden"
          name="VerificationID"
          class="VerificationID randomid"
        />
        <input type="hidden" name="HealthFacilityID" class="HealthFacilityID" />
        <input type="hidden" name="VerifyingUserID" class="VerifyingUserID" />
        <input type="hidden" name="ProvinceID" class="ProvinceID" />
        <input type="hidden" name="DistrictID" class="DistrictID" />
        <input type="hidden" name="ConstituencyID" class="ConstituencyID" />
        <input type="hidden" name="WardID" class="WardID" />
        <input type="hidden" name="VillageID" class="VillageID" />
        <input type="hidden" name="created_at" class="created_atw" />
      </form>
    </div>
    ...
    <div class="card-header mt-3">
      ...
      >
        Currently Selected Signal's Info
      </h1>
    </div>
